...
namespace Trinity.Client.TestProtocols
{
    ...
    /// The target field to query on is specified with <paramref name="query"/>, <seealso cref="Trinity.Client.TestProtocols.IndexIdentifier"/>.
    /// </summary>
    public class Index
    {
        static Index()
        ...
        /// instance, accessible through Trinity.Client.TestProtocols.Index.Target_Cell_Name.Target_Field_Name.
        /// </summary>
